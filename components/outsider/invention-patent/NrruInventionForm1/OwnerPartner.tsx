    ...
    >
          ...
          <TextField className={"flex w-full items-center gap-3 "}>
            ...
            <div className="flex w-96 flex-col gap-1">
              <Input
                ...
                type="text"
                className="h-8 w-full rounded-lg bg-slate-300 p-1 pl-3 lg:h-10 lg:pl-4 "
            ...
            <TextField className={"flex w-full items-center gap-3 lg:w-[50%]"}>
              ...
              <div className="flex flex-col gap-1">
                <Input
                  ...
                  type="text"
                  className="h-8 w-20 rounded-lg bg-slate-300 p-1 pl-3 lg:h-10 lg:w-24 lg:pl-4 "
            ...
            <TextField className={"flex w-full items-center gap-3 lg:w-[50%]"}>
              ...
              <div className="flex flex-col gap-1">
                <Input
                  ...
                  name="firstName"
                  type="text"
                  className="h-8 w-40 rounded-lg bg-slate-300 p-1 pl-3 lg:h-10 lg:w-44  lg:p-2 lg:pl-4"
            ...
            <TextField className={"flex w-full items-center gap-3 lg:w-[50%]"}>
              ...
              <div className="flex flex-col gap-1">
                <Input
                  ...
                  name="lastName"
                  type="text"
                  className="h-8 w-36 rounded-lg bg-slate-300 p-1 pl-3 lg:h-10 lg:w-44  lg:p-2 lg:pl-4"
                  placeholder="นามสกุล"
                />
                <FieldError className="text-xs text-red-700" />
              </div>
      ...
      <section className="flex items-start justify-center gap-3 lg:items-center lg:gap-5">
        ...
        <div className="flex w-full flex-col gap-3 text-[0.8rem] lg:flex-row lg:gap-5 lg:text-base">
          ...
          >
            <Label className=" text-[var(--primary-blue) min-w-24 font-semibold lg:w-72">
            ...
            <div className="flex flex-col gap-1">
              <InputMask
                ...
                onChange={handleChangePartnerData}
                name="idCard"
                className="h-8 w-56 rounded-lg  bg-slate-300 p-1 pl-3 lg:h-10 lg:w-72 lg:pl-4 "
          ...
          <TextField className={"flex  items-center gap-3  "}>
            ...
            <div className="flex flex-col gap-1">
              <Input
                ...
                name="villageNumber"
                type="text"
                className="h-8 w-40   rounded-lg bg-slate-300 p-1 pl-3 lg:h-10 lg:pl-4 "
                placeholder="หมู่"
              />
              <FieldError className="text-xs text-red-700" />
            </div>
          ...
          <TextField className={"flex  items-center gap-3  "}>
            ...
            <div className="flex flex-col gap-1">
              <Input
                ...
                name="zipCode"
                type="text"
                className="h-8 w-24 rounded-lg bg-slate-300 p-1 pl-3 lg:h-10 lg:w-40 lg:pl-4 "
                placeholder="36120"
              />
              <FieldError className="text-xs text-red-700" />
            </div>
      ...
      <section className="flex items-start justify-center gap-3 lg:items-center lg:gap-5">
        ...
        <div className="flex w-full flex-col gap-3 text-[0.8rem] lg:flex-row lg:gap-5 lg:text-base">
          <TextField className={"flex w-full items-center gap-3 lg:w-[40%] "}>
            <Label className=" text-[var(--primary-blue) min-w-14 font-semibold lg:min-w-20">
              E-mail
            </Label>

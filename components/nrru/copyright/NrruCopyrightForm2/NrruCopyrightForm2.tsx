...
const NrruCopyrightForm2 = forwardRef(
  ({ copyright }: NrruCopyrightForm2Props, ref) => {
    ...
    const [workData, setWorkData] = useState<{
      ...
      return {
        ...
        files:
          copyright.data?.workInfoOnCopyright.fileWorkInfoOnCopyrights?.map(
            (file) => {
              return {
                id: file.id,
                url: file.url,
        ...
        tranferPermission:
          copyright.data?.workInfoOnCopyright.tranferPermission,
                      ...
                      {quality === "อื่น ๆ (ระบุ)" && (
                        ...
                        >
                          <section className="flex w-full flex-col">
                            <Input
                              required={
                                workData?.workQuality === "อื่น ๆ (ระบุ)"
                              }
                              disabled={
                                workData?.workQuality !== "อื่น ๆ (ระบุ)"
                              }

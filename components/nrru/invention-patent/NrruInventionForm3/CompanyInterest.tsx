  ...
  return (
    <section className="flex flex-col items-start justify-center gap-2 md:gap-5 ">
      ...
      <div className="=text-[0.8rem] flex w-full flex-col flex-wrap gap-3 md:flex-row md:gap-5 md:text-base">
        <section className="flex w-10/12 flex-col justify-between md:flex-row md:items-center ">
          <p>
        ...
        <section className="flex w-10/12 items-center justify-between rounded-md border-[1px] border-solid border-[#BED6FF] p-2 ">
        ...
        {invention.data?.supportingDataOnInventionPatent.companyInterestedOnSupportingDataInventionPatents.map(
          (company, index) => {
            return (
              <li
                key={index}
                className="flex w-10/12 items-center justify-between rounded-md

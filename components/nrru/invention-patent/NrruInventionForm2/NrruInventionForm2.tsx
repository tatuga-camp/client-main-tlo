...
const NrruInventionForm2 = forwardRef(
  ({ invention }: InventSection2Props, ref) => {
          ...
          >
            <div className="flex flex-col gap-1">
              <section className="flex items-center gap-3">
                <Number number={4} />
                <Label className="my-2 text-[0.8rem] font-semibold lg:min-w-64 lg:text-base">
                  สิ่งที่ได้จากการประดิษฐ์/งานวิจัย/ข้อค้นพบ (ตอบได้มากกว่า 1
                  ข้อ)
                </Label>
              </section>
              <FieldError className="text-xs text-red-700" />
            ...
            <div>
              <TextField className={`ml-3 flex  gap-5`}>
                <Input
                  ...
                  onChange={handleChangeWorkData}
                  className="w-32 rounded-md bg-slate-300  p-1 pl-3 text-[0.8rem] lg:w-96  lg:p-2  lg:pl-4 lg:text-base"

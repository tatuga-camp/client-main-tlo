...
function FileOnTrademark({ file, handleDeleteFile }: FileOnInventionProps) {
  ...
  return (
   ...
   cursor-pointer items-center justify-center gap-2 rounded-md bg-green-500 p-1  text-xl text-white"
        ...
        <button
          type="button"
          onClick={() =>
            handleDeleteFile({ url: file.url, fileOnTrademarkId: file.id })
          }
...
export default FileOnTrademark;

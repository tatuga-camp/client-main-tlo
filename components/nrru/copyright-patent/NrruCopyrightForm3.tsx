    ...
    <div className=" w-full  rounded-md border-[1px] border-solid border-[#BED6FF] bg-white p-5 py-10 md:p-10">
      <Form className="mx-0 my-5 flex flex-col gap-5 md:mx-5 md:my-10 ">
        ...
        <section className="flex flex-col items-start justify-center gap-2 md:gap-5 ">
          ...
          <CheckboxGroup className="ml-5 flex flex-col items-start justify-center gap-2 md:ml-10 md:gap-5 ">
        ...
        <section className="flex flex-col items-start justify-center gap-2 md:gap-5 ">
          ...
          <RadioGroup className="my-3 ml-5 flex flex-col items-start justify-center gap-2 md:ml-10 md:gap-5  lg:flex-row">
            <div className="flex w-full flex-col  gap-1.5 px-5 text-[0.8rem] md:gap-3 md:pl-0 md:text-base">
              ...
              <TextField
                className={
                  "md:-10 ml-5 flex w-full items-center gap-3 md:w-[70%]"
                }
              >
                <section className="flex w-full flex-col">
                  <Input
                    name=""
                    type="text"
                    className="h-8 min-w-56 rounded-md bg-slate-300 p-1 pl-3 md:h-10 md:pl-4 "

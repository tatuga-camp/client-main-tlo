...
export async function CreateCompanyInventionPatentService(
...
export async function UpdateCompanyInventionPatentService(
...
export async function DeleteCompanyInventionPatentService(

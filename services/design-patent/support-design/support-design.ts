...
export async function CreateSupportDesignPatentervice(
...
export async function UpdateSupportDesignPatentervice(
...
export async function DeleteSupportDesignPatentervice(

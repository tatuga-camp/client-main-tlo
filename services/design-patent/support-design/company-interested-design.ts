...
export async function CreateCompanyDesignPatentervice(
...
export async function UpdateCompanyDesignPatentervice(
...
export async function DeleteCompanyDesignPatentervice(
